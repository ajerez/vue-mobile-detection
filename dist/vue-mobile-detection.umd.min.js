(function (e, t) {
  "object" === typeof exports && "object" === typeof module
    ...
    ? (exports["vue-mobile-detection"] = t())
    : (e["vue-mobile-detection"] = t());
  ...
  return (function (e) {
        ...
        function e() {
          ...
          try {
            ...
            var n,
              ...
              i = /.*at [^(]*\((.*):(.+):(.+)\)$/gi,
              c = /@([^@]*):(\d+):(\d+)\s*$/gi,
              a = i.exec(s.stack) || c.exec(s.stack),
              u = (a && a[1]) || !1,
              p = (a && a[2]) || !1,
            ...
            for (var l = 0; l < m.length; l++) {
              ...
              if (u === d && m[l].innerHTML && m[l].innerHTML.trim() === o) return m[l];
            }
            return null;
          }
        }
    ...
    fb15: function (e, t, n) {
      ...
      var a = {
        install: function (e) {
          e.config.globalProperties.$isMobile = c;
        },
      };
      t["default"] = a;
    },
